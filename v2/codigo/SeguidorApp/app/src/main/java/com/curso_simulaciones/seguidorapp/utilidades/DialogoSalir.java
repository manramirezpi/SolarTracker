...
public class DialogoSalir {
    ...
    private void gestionarResolucion() {
        tamano_letra_25 = (int) (0.8f * AlmacenDatosRAM.tamanoLetraResolucionIncluida);
        tamano_letra_20 = (int) (1.2f * AlmacenDatosRAM.tamanoLetraResolucionIncluida);
    }
    ...
    private void crearGUI() {
        ...
        linear_layout_principal.setWeightSum(2);
        ...
        si.setText("SI");
        si.getBackground().setColorFilter(Color.rgb(183, 216, 199), PorterDuff.Mode.MULTIPLY);

        no = new Button(actividad);
        no.setTextSize(tamano_letra_25);
        no.setText("NO");
        no.getBackground().setColorFilter(Color.rgb(183, 216, 199), PorterDuff.Mode.MULTIPLY);
    ...
    public void mostrarPopMenuCoeficientes() {
