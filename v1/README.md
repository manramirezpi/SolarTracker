...
- **Microcontrolador:** Familia STM32F4 (frecuencia de reloj a 100 MHz).
- **Periféricos:**
...
*   **Arquitectura no bloqueante:** Gestión de periféricos (UART) mediante **DMA** para garantizar la integridad de los tiempos de ciclo del microcontrolador.
